<template>
    ...
    <v-dialog v-model="showModal" width="auto">
        <v-card max-width="600" width="600" prepend-icon="mdi-pen" title="Modifier le produit" class="px-2">
            <v-form class="mt-4">
                <v-text-field variant="outlined" label="Référence produit"
                    v-model="productToEdit.value.ref"></v-text-field>
                ...
                <v-text-field variant="outlined" label="Nom du fournisseur"
                    v-model="productToEdit.value.sellerName"></v-text-field>
                ...
                <v-text-field variant="outlined" label="Flux d'approvisionnement"
                    v-model="productToEdit.value.supplyFlow"></v-text-field>
                <v-text-field variant="outlined" label="Flux de transfert"
                    v-model="productToEdit.value.transferFlow"></v-text-field>
                <v-text-field variant="outlined" label="Type de plateau"
                    v-model="productToEdit.value.trayType"></v-text-field>
                <v-text-field variant="outlined" label="Contenant"
                    v-model="productToEdit.value.container"></v-text-field>
                <v-text-field variant="outlined" label="Contenu (quantité)"
                    v-model="productToEdit.value.quantity"></v-text-field>
                <v-text-field variant="outlined" label="Type d'ensachage"
                    v-model="productToEdit.value.baggingType"></v-text-field>
                <v-text-field variant="outlined" label="Type d'écrin"
                    v-model="productToEdit.value.boxType"></v-text-field>
                <v-text-field variant="outlined" label="SF Convoyeur"
                    v-model="productToEdit.value.conveyorReception"></v-text-field>
            </v-form>
